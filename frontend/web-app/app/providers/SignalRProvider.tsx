...
export default function SignalRProvider({children, user, notificationsUrl}: Props) {
    ...
    }, [handleAuctionCreated, handleAuctionFinished, handleBidPlaced, notificationsUrl, setCurrentPrice])
